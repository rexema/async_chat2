...
def listen(s: socket.socket, host: str, port: int):
    while True:
        ...
        if '__' in msg:
            ...
            LOGGER.info(f'Client{peer_name} send a message')
...
def main():
    ...
    LOGGER.info(f'Client connected to host: {host}, port: {own_port}')
    ...
    while True:
        ...
        if command in COMMANDS:
            ...
            if msg == '/exit':
                ...
                LOGGER.info(f'Client {peer_port} diconnected')
            ...
            try:
                ...
                if msg.startswith('/connect'):
                    ...
                    LOGGER.info(f'Client {s} connected to client {peer_port}')
            except ValueError:
                LOGGER.error(f'Not correct data')
                continue
